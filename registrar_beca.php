...
echo "nombre_sesion".$var_nombre_ses =  $_SESSION['nombre'];   
...
if ($resultado->num_rows > 0){
  ...
  //echo "*ERROR* ya estas registrado";echo "<br>";
...
{
$sql9 ="INSERT INTO aspirantes (ASP_STATUS,ASP_ID_USUARIO) VALUES ('Pendiente','$var_id_foranea6')";
...
echo "<br>";
echo "Id_foranea:".$var_id_foranea1 = $_SESSION['clave'];   //clave  es el id del usaurio
echo "<br>";
//PArte de madre
...
//$destino = 'files/'.$var_id_aspirante.'/'. $_FILES['archivo']['name'];
$ruta = 'files/'.$var_id_aspirante.$var_nombre_ses.'/';
$archivo = $ruta.$_FILES["archivo"]["name"];
if(!file_exists($ruta)){
				mkdir($ruta);
			}	
//'files/'.$id_insert.'/';  $var_id_aspirante
...
echo "<br>";
//Tabla Parte prepa
echo "Que estas cursando:".$var_cursando2= $_POST['cursando2'];
echo "<br>";
echo "Nombre de la escuela:".$var_nombre_escuela2 = $_POST['nombre_escuela2'];
echo "<br>";
echo "Direccion de la escuela:".$var_direccion_escuela2 = $_POST['direccion_escuela2'];
echo "<br>";
echo "Años cursados :".$var_años_cursados2 = $_POST['años_cursados2'];
echo "<br>";
echo "Promedio:".$var_promedio2 = $_POST['promedio2'];
echo "<br>";
echo "Titulo:".$var_titulo2 = $_POST['titulo2'];
echo "<br>";
echo "Id_foranea:".$var_id_foranea3 = $_SESSION['clave'];
echo "<br>";
...
//$destino2 = 'files/'.$var_id_aspirante.'/'. $_FILES['archivo2']['name'];
$ruta = 'files/'.$var_id_aspirante.$var_nombre_ses.'/';
$archivo2 = $ruta.$_FILES["archivo2"]["name"];
...
//move_uploaded_file($var_archivo2,$destino2);

echo "<br>";

echo "Archivo3:".$var_archivo3 = $_FILES['archivo3']['tmp_name'];
$ruta = 'files/'.$var_id_aspirante.$var_nombre_ses.'/';
$archivo3 = $ruta.$_FILES["archivo3"]["name"];
...
echo "<br>";
echo "Archivo4:".$var_archivo4 = $_FILES['archivo4']['tmp_name'];
$ruta = 'files/'.$var_id_aspirante.$var_nombre_ses.'/';
$archivo4 = $ruta.$_FILES["archivo4"]["name"];
			
			if(!file_exists($ruta)){
				mkdir($ruta);
			}
move_uploaded_file($_FILES["archivo4"]["tmp_name"], $archivo4);
echo "<br>";
echo "Archivo5:".$var_archivo5 = $_FILES['archivo5']['tmp_name'];
$ruta = 'files/'.$var_id_aspirante.$var_nombre_ses.'/';
$archivo5 = $ruta.$_FILES["archivo5"]["name"];
			
			if(!file_exists($ruta)){
				mkdir($ruta);
			}
move_uploaded_file($_FILES["archivo5"]["tmp_name"], $archivo5);
echo "<br>";
echo "Id_foranea:".$var_id_foranea6 = $_SESSION['clave'];
echo "<br>";
...
//Insercion 4
$sql4 = "INSERT INTO escolaridad (ESC_CURSANDO_ESC,ESC_NOMBRE_ESC,
	ESC_DOMICILIO_ESC,
	ESC_YEARS_CURSADOS,
	ESC_PROMEDIO,
	ESC_TITULO,
...
VALUES ('$var_cursando2',
 '$var_nombre_escuela2' ,
 '$var_direccion_escuela2' ,
 '$var_años_cursados2' ,
 '$var_promedio2' ,
 '$var_titulo2' ,
 '$var_id_aspirante'
...
$sql5 = "INSERT INTO act_extra (EXT_INSTITUCION,
	EXT_DESCRIP_ACTV,
	EXT_TOTAL_HORAS,
	EXT_FECHA_INI,
	EXT_FECHA_FINAL,
...
//Insercion 6
$sql6 = "INSERT INTO reconocimientos (REC_INSTITUCION,
	REC_DESCRIPCION,
...
//Insercion 7
$sql7 = "INSERT INTO pro_estudio (PROP_CARRERA_CURSAR,
	PROP_UNIVERSIDAD,
	PROP_TIEMPO,
	PROP_DESCRIPCION,
	PROP_CONTAC_UNI,
...
$cal="SELECT ESC_PROMEDIO FROM escolaridad where ESC_PROMEDIO='$var_promedio2' and ESC_ID_ASPIRANTES='$var_id_aspirante'and ESC_CURSANDO_ESC='$var_cursando2'";
$resultado = $conn->query($cal);
$variable = $resultado;
$variable = (int) $variable;

switch($var_promedio2)
    {
    case ($var_promedio2 < 85):
    $sql10 ="UPDATE aspirantes SET ASP_PRESELECCION='Bajo' WHERE ASP_ID_USUARIO='$var_id_foranea6' ";
    break;
 
    case (($var_promedio2 >= 85) && ($var_promedio2 <= 95)):
   $sql11 ="UPDATE aspirantes SET ASP_PRESELECCION='Medio' WHERE ASP_ID_USUARIO='$var_id_foranea6' ";
    break;
 
    case (($var_promedio2 >= 95) && ($var_promedio2 = 100)):
...
if ($conn->query($sql) === TRUE) {
    echo "El registro ha sido agregado correctamente";echo "<br>";
...
//header("Location: solicitar_beca.php");
 ...
 echo "sql10= El registro ha sido agregado correctamente";echo "<br>";
}
 if ($conn->query($sql11) === TRUE) {
echo "sql11= El registro ha sido agregado correctamente";echo "<br>";
...
echo "sql11= El registro ha sido agregado correctamente";echo "<br>";
	...
	echo "<script>alert('Se inserto un dato erroneo o un campo vacio en Familiares!')</script>";
     echo "<script>window.open('solicitar_beca.php','_self')</script>";
    //echo "Error: " . $sql1 . "<br>" . $conn->error;echo "<br>";
}
