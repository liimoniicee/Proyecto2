...
<!--<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
 <select name="nivel" required="true" class="form-control border-input"   name="tipo_event" >
...
<div class="form-group">
    ...
    <div class="col-sm-5">
       ...
       <input type="number" name="calificacion" class="form-control border-input" min="0" required="true" autocomplete="off" placeholder="calificación">
     </div>
  </div>
<!--fin fecha inicio-->
...
<!--fin fecha fins-->
 ...
 <!--Actividades-->
  <div class="form-group">
    <label class="col-sm-2 control-label">Unidad</label>
    <div class="col-sm-5">
 <select name="unidad"  class="form-control border-input" required="true"  name="tipo_event" >
            <option selected="" disabled="">Seleccionar...</option>
...
<!--fin div Actividades-->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="number" class="form-control border-input" required="true"  placeholder="Promedio" min="0" name="promedio">
    </div>
  </div>
    ...
    <div class="col-sm-5">
      <input type="integer" class="form-control border-input" required="true"  placeholder="id" name="id_foranea2">
    </div>
  </div>
                ...
                <div class="form-group">
                     ...
                     <!--Boton con submit para registrara los datos -->
                         <button type="submit" class="btn btn-info btn-fill btn-wd">Asignar calificación</button>
                         </div>
                         </div>
                        <br>
                        <br>
...
<div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="title">No. control de becarios</h4>
                            <p class="category">Lista de becarios activos <a h
...
//Conexón con la base de datos
                                          include 'conexion.php';
                                          //Consulta para obtener los datos de los becarios por el id
            ...
            ?>
                                        <tbody>
                                            <tr>
                                            <!--Obtiene los datos por medio de la variables de php -->
                                           <td><?php echo $id_c; ?></td>
