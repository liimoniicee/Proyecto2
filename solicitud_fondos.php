                        ...
                        <div class="card">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nom" class="form-control border-input" placeholder="Nombre del evento" required maxlength="25" onkeypress="return validar(event)">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Requisito</label>
                                    <input type="number" name="req" class="form-control border-input" placeholder="Requisito monetario" required type="number">
                                </div>
                            </div>
														...
														<div class="col-md-2">
																<div class="form-group">
																		...
																		<input type="text" name="org" class="form-control border-input" placeholder="Nombre del organizador" maxlength="25" onkeypress="return validar(event)" required>
																</div>
														</div>
														<div class="col-md-3">
																<div class="form-group">
																		<label for="exampleInputEmail1">Ubicación</label>
																		<input type="text" name="ubi" class="form-control border-input" placeholder="Ubicación" maxlength="25" onkeypress="return validar(event)" required>
																</div>
                              </div>
														</div>
                            <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="obj" class="form-control border-input" placeholder="Objetivo Gral" maxlength="25" onkeypress="return validar(event)" required>
                                </div>
                            </div>
...
swal({
 ...
 '<label for="exampleInputEmail1">Nombre del evento</label>' +
 '<input name="swal-input1" id="swal-input1" class="form-control border-input maxlength="25" onkeypress="return validar(event)" required">' +
 '<label for="exampleInputEmail1">Requisito</label>' +
 '<input name="swal-input2" id="swal-input2" class="form-control border-input type="number"">' +
 '<label for="exampleInputEmail1">Organizador</label>' +
 '<input name="swal-input3" id="swal-input3" class="form-control border-input maxlength="25" onkeypress="return validar(event)" required">' +
 '<label for="exampleInputEmail1">Ubicación</label>' +
 '<input name="swal-input4" id="swal-input4" class="form-control border-input maxlength="25" onkeypress="return validar(event)" required">' +
 '<label for="exampleInputEmail1">Objetivo del evento</label>' +
 '<input name="swal-input5" id="swal-input5" class="form-control border-input maxlength="25" onkeypress="return validar(event)" required">' +
 '<label for="exampleInputEmail1">Fecha inicio</label>' +
 '<input name="swal-input6" id="swal-input6" class="form-control border-input type="date"">' +
 '<label for="exampleInputEmail1">Fecha fin</label>' +
 '<input name="swal-input7" id="swal-input7" class="form-control border-input type="date""></br>'+
