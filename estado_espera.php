...
?>
                                                  <!--Se muestra el dato por medio de una variable php $var_status que muestra el estado actual del aspirante-->
                                                    <input type="text" class="form-control border-input" value="<?php echo $var_status ?>" readonly="readonly" name="ape_pat" onkeypress="return validar(event)" required>
                                                </div>
                                            </div>
                                          </div>
                                        </li>
