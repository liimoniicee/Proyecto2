                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form method="POST" action="altateams.php" class="form-horizontal">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nombre </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="team_nombre" required>
                                        </div>
                                    </div>
                                </fieldset>
                   ...
                   <div class="radio radio-inline">
                     <input id="checkbox50" type="radio" name="integrantes" required value="2">
                     <label for="checkbox50">2</label>
                   </div>
                   <div class="radio radio-inline">
                     <input id="checkbox51" type="radio" name="integrantes" required value="3">
                     <label for="checkbox51">3</label>
                   </div>
                   <div class="radio radio-inline">
                     <input id="checkbox52" type="radio" name="integrantes" required value="4">
                     <label for="checkbox52">4</label>
                   </div>
                   <div class="radio radio-inline">
                     <input id="checkbox52" type="radio" name="integrantes" requireds value="5">
                     <label for="checkbox52">5</label>
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                          <div class="radio">
                                            <input type="radio" name="tipo" id="radio1" value="Limpieza" checked="" required>
                                            <label for="radio1">
                                              Equipo de Limpieza
                                            </label>
                                          </div>
                                          ...
                                          <div class="radio">
                                            <input type="radio" name="tipo" id="radio2" value="Cocina" required>
                                            <label for="radio2">
                                              Equipo de Cocina
                                            </label>
                                          </div>
