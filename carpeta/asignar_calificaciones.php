...
<!--<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
 <select name="nivel"  class="form-control border-input" required="true"  name="tipo_event" >
...
<!--fin div Actividades-->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="number" class="form-control border-input"  placeholder="Promedio" min="0" name="promedio">
    </div>
  </div>
    ...
    <div class="col-sm-5">
      <input type="integer" class="form-control border-input"  placeholder="id" name="id_foranea2">
    </div>
  </div>
