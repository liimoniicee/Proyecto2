...
<!--$nuevo_usuario="SELECT ASI_ASISTENCIA FROM asistencia WHERE ASI_ID_BECARIO='$idbec'"; 
...
{ 
$sql9 ="INSERT INTO asistencia (ASI_ASISTENCIA,ASI_ID_BECARIO,ASI_FECHA) VALUES ('falto','$idbec','$fecha_actual')";-->
