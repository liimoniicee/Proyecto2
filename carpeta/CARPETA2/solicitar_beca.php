...
<script type="text/javascript">
    ...
    function habilitar2(){
       ...
       $("input[id='radio_si2']").bind('change', function(){
        ...
        $("input[id='radio_no2']").bind('change', function(){
            if($(this).is(":checked") ==true){
                $("input[id='ingles']").prop('disabled',true);
            }
       });
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="col-md-5">
                                                        <div class="form-group">
                                                          ...
                                                          <input class="" type="radio" name="opcasa" value="Si"  required="true"  >Si
                                                          <input class="" type="radio" name="opcasa" value="No"   required="true"> No
                                                        </div>
                                                    </div><!--dIV DEL COLUMNA -->
                                             ...
                                             <div class="row">
                                              <div class="col-md-5 col-md-offset-1">
                                                       ...
                                                       <label class="control-label">
                                                            ...
                                                            <!--     IMPORTANT! - the "bootstrap select picker" is not compatible with jquery.validation.js, that's why we use the "default select" inside this wizard. We will try to contact the guys who are responsibble for the "bootstrap select picker" to find a solution. Thank you for your patience.
                                                             -->
                                                            <select name="materiales" class="form-control"  required="true">
                                               ...
                                               <div class="col-md-5">
                                                        <div class="form-group">
                                                          ...
                                                          <input type="radio" name="opauto" value="Si"  required="true"  >Si
                                                          <input type="radio" name="opauto" value="No"  required="true" > No
                                                        </div>
                                                    </div><!--dIV DEL COLUMNA -->
                                             </div> <!-- ROW -->
                                              ...
                                              <div class="col-md-5 col-md-offset-1">
                                                      <div class="form-group">
                                                           ...
                                                           <input type="radio"  required="true" name="opbanco" value="Si" id="radio_si" onkeyUp="habliitar()">Si
                                                           <input type="radio"  required="true" name="opbanco" value="No" id="radio_no" onkeyUp="habliitar()"> No
                                               ...
                                               <div class="col-md-5">
                                                         <div class="form-group">
                                                            <label class="control-label">
                                                                Subir estado de cuenta(Formato en PDF)<star>*</star>
                                                            </label>
                                                            <input class="form-control"
                                                                   type="file"
                                                                   name="archivo"
                                             ...
                                             <div class="row">
                                              <div class="col-md-5 col-md-offset-1">
                                                        <div class="form-group">
                                                          ...
                                                          <input type="radio"  required="true" name="optrabajas" value="Si" >Si
                                                          <input type="radio"  required="true" name="optrabajas" value="No" > No</br>
                                                        </div>
                                            </div> <!--dIV DEL COLUMNA -->
                                               ...
                                               <div class="col-md-5">
                                                        <div class="form-group">
                                                          ...
                                                          <input type="radio"  required="true" name="opbeca" value="completa" >Completa
                                                          <input type="radio"   required="true" name="opbeca" value="parcial" >Parcial</br>
                                                        </div>
                                                    </div><!--dIV DEL COLUMNA -->
                                             </div> <!-- ROW -->
                                              ...
                                              <div class="col-md-5 col-md-offset-1">
                                                 <div class="form-group">
                                                          ...
                                                          <input type="radio"  required="true" name="opinternet" value="Si" >Si
                                                          <input type="radio"   required="true" name="opinternet" value="No" > No</br>
                                                        </div>
                                            </div> <!--dIV DEL COLUMNA -->
                                               ...
                                               <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="radio"  required="true" name="opingles"id="radio_si2" onkeyUp="habliitar2()"value="Si"  >Si
                                                            <input type="radio" required="true" name="opingles" id="radio_no2" onkeyUp="habliitar2()" value="No" > No</br>
                                                        </div>
                                                    </div><!--dIV DEL COLUMNA -->
                                             </div> <!-- ROW -->
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                      ...
                                                      <div class="col-md-5 col-md-offset-1">
                                                       ...
                                                       <input type="radio" name="optiempo" value="Si"  required="true" >Si
                                                       <input type="radio" name="optiempo" value="No"  required="true" > No</br>
                                                           <!-- <input type="hidden" value="1" name="opcion">-->
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                         ...
                                                         <input type="radio" name="opcontacto"  value="Si"  required="true" >Si
                                                         <input type="radio" name="opcontacto" value="No"  required="true"> No</br>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
...
<div class="col-md-10 col-md-offset-1">
                                                        <div class="form-group">
                                                            <label class="control-label">
                                                                           Carta recomendación de parte de la escuela cursada, en este caso de la preparatoria(En formato PDF).<star>*</star>
                                                            </label>
                                                            <input class="form-control"
                                                                   type="file"
                                                                   name="archivo3"
                                                    ...
                                                    <div class="col-md-10 col-md-offset-1">
                                                        <div class="form-group">
                                                            <label class="control-label">
                                                                          Copia de boleta de calificacones de la preparatoria cursada(En formato PDF).<star>*</star>
                                                            </label>
                                                            <input class="form-control"
                                                                   type="file"
                                                                   name="archivo4"
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">
                                                                    Croquis de la ubicación de tu casa, puede ser captura en google maps(En formato PDF).<star>*</star>
                                                            </label>
                                                            <input class="form-control"
                                                                   type="file"
                                                                   name="archivo5"
