 ...
 include 'conexion.php';
    ...
    <script>
         ...
         '<input type="hidden" name="swal-input0" id="swal-input0" class="form-control border-input">' +
          ...
          '<input  type="number" min="0"name="swal-input3" id="swal-input3" class="form-control border-input">' +
          '<label for="exampleInputEmail1">Apellido P</label>' +
          '<input type="text" min="0" name="swal-input4" id="swal-input4" onkeypress="return validar(event)" class="form-control border-input">' + 
          '<label for="exampleInputEmail1">Apellido M</label>' +
          '<input name="swal-input5" onkeypress="return validar(event)" id="swal-input5" class="form-control border-input">' +
          '<label for="exampleInputEmail1">Nombre</label>' +
          '<input type="text" min="0" name="swal-input6" id="swal-input6" onkeypress="return validar(event)" class="form-control border-input">' +
          '<label for="exampleInputEmail1">Direccón</label>' +
          '<input  type="text" min="0"name="swal-input7" id="swal-input7" class="form-control border-input">' +
          ...
          '<input name="swal-input9" onkeypress="return validar(event)" id="swal-input9" class="form-control border-input">' +
          '<label for="exampleInputEmail1">Img</label>' +
          '<input type="text" min="0" name="swal-input10" id="swal-input10" class="form-control border-input">' +
          '<label for="exampleInputEmail1">telefono</label>' +
          '<input  type="number" min="0"name="swal-input11" id="swal-input11" class="form-control border-input">' +
          '<label for="exampleInputEmail1">Celular</label>' +
          '<input type="number" min="0" name="swal-input12" id="swal-input12" class="form-control border-input">' + 
           '<label for="exampleInputEmail1">Lugar de nacimiento</label>' +
          '<input name="swal-input13" onkeypress="return validar(event)" id="swal-input13" class="form-control border-input">' +
          '<label for="exampleInputEmail1">Fecha</label>' +
          '<input type="date" min="0" name="swal-input14" id="swal-input14" class="form-control border-input">' +
          '<label for="exampleInputEmail1">Sexo</label>' +
          '<input  type="text" min="0"name="swal-input15" id="swal-input15" class="form-control border-input">' +
