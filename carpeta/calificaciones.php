 ...
 include 'conexion.php';
    ...
    <script>
         ...
         '<input type="hidden" name="swal-input0" id="swal-input0" class="form-control border-input">' +
          ...
          '<input name="swal-input1" onkeypress="return validar(event)" id="swal-input1" class="form-control border-input">' +
          '<label for="exampleInputEmail1">Calificación</label>' +
          '<input type="number" min="0" name="swal-input2" id="swal-input2" class="form-control border-input">' +
          ...
          '<input type="number" min="0" name="swal-input4" id="swal-input4" class="form-control border-input">' + 
