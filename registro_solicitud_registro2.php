...
echo "<br>";
echo "Nombre:".$var_roll = $_POST['roll'];
...
VALUES ('$var_usuario' , '$pass_encriptada', '$var_roll' , '$var_apellidop' , '$var_apellidom' ,'$var_nombre','$var_direccion','$var_colonia','$var_cp','assets/img/perfil.png','$var_telefono','$var_celular','$var_lugar_nacimiento','$var_fecha_nac','$var_opsexo','0')";
...
if ($conn->query($sql) === TRUE) {
	...
	//header("Location: index.html");
        ...
        echo "<script>window.open('registro_empleados.php','_self')</script>";
