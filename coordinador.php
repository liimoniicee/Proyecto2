                                ...
                                <div class="card-content">
                                    <div class="author">
                                      ...
                                      <h4 class="card-title"><?php echo $_SESSION['nombre'];?><br />
                                        ...
                                        <form action="guardar_foto_coordinador.php" method="post" enctype="multipart/form-data">
...
return patron.test(te);
                            ...
                            <!--Envia el metodo POST hacia editar.ingles.php-->
                                 <form method="post" action="editar_coordinador.php">
                                        <div class="row">
                                            <div class="col-md-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control border-input"   name="codigop" value="<?php echo $var_codigopost ?>" min="0" required>
                                                </div>
                                            </div>
                                        </div>
