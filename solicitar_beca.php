                                              ...
                                              <div class="col-md-5 col-md-offset-1">
                                               ...
                                               <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="radio" name="opingles"id="radio_si2" onkeyUp="habliitar2()"value="Si"  >Si
                                                            <input type="radio" name="opingles" id="radio_no2" onkeyUp="habliitar2()" value="No" > No</br>
                                                        </div>
                                                    </div><!--dIV DEL COLUMNA -->
                                             </div> <!-- ROW -->
                                            <div class="row">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <div class="copyright pull-right">
                        &copy; <script>document.write(new Date().getFullYear())</script>, made with <i class="fa fa-heart heart"></i> by <a href="#">Schoolar</a>
                    </div>
                </div>
            </footer>
        </div>
