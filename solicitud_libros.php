                        ...
                        <div class="card">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nom_mae" class="form-control border-input" placeholder="Nombre completo del profesor" maxlength="25" onkeypress="return validar(event)" required>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Materia</label>
                                    <input type="text" name="mat" class="form-control border-input" placeholder="Nombre de la materia" maxlength="25" onkeypress="return validar(event)" required>
                                </div>
                            </div>
														...
														<div class="col-md-3">
																<div class="form-group">
																		...
																		<input type="text" name="escu" class="form-control border-input" placeholder="Nombre escuela" maxlength="25" required>
																</div>
														</div>
														<div class="col-md-2">
																<div class="form-group">
																		<label for="exampleInputEmail1">Semestre</label>
																		<input type="text" name="semes" class="form-control border-input" placeholder="Semestre actual" required maxlength="15">
																</div>
														</div>
                            <div class="col-md-3">
																<div class="form-group">
																		<label for="exampleInputEmail1">Vendedor</label>
																		<input type="text" name="vend" class="form-control border-input" maxlength="25" onkeypress="return validar(event)" required>
																</div>
														</div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="descrip" class="form-control border-input" placeholder="Descripción del libro" maxlength="40" onkeypress="return validar(event)" required>
                                </div>
                            </div>
														<div class="col-md-3">
																<div class="form-group">
...
<script>
          ...
          '<label for="exampleInputEmail1">Materia</label>' +
          '<input name="swal-input2" id="swal-input2" class="form-control border-input maxlength="25" onkeypress="return validar(event)" required">' +
          '<label for="exampleInputEmail1">Vendedor</label>' +
          ...
          '<label for="exampleInputEmail1">Descripción</label>' +
          '<input name="swal-input6" id="swal-input6" class="form-control border-input maxlength="25" onkeypress="return validar(event)" required">'+
          '<label for="exampleInputEmail1">Fecha</label>' +
